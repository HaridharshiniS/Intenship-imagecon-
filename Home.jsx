      ...
      <div className="container mt-5">
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="card">
              <img
                src="https://m.media-amazon.com/images/S/aplus-media-library-service-media/ac558873-aafe-4457-b9db-be09c84479dd._CR0,0,1080,1080_PT0_SX300_V1.jpg"
                className="card-img-top"
                alt="Product 2"
              />
              <div className="card-body">
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-4">
            <div className="card">
              <img
                src="https://m.media-amazon.com/images/S/aplus-media-library-service-media/4a2413e9-916c-433d-a130-b363d970774d._CR0,253,1027,1027_PT0_SX300_V1.jpg"
                className="card-img-top"
                alt="Product 1"
              />
              <div className="card-body">
